### Function to identify the correct number of components for a PLSR model using the RMSE values


num_comps = function(param,dataWQ,dataCalFP,TS_FP){
  ...
  ncomps = c(1:10)
  param= param #the nutrient you want to find the number of comps for 
  ...
  #png("RMSE_plot_epi.png",width = 9, height = 4, units = 'in', res = 300)
