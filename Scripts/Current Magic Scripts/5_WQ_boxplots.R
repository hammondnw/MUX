...
#*****************************************************************
#* TITLE:  MUx Manuscript Boxplots Script
#*                     
#* AUTHORS: Nick Hammond                                         
#* LAST UPDATED: 18 Oct 2022
#*                                    
#* NOTES:  This script utilizes the PLSR calibration datasets to create boxplots of 
#*         sampling data for each PLSR model (depth + variable combo)
...
pathD<-"MagicData/MUX/Figures Files/" #EDIT: Specify folder where data is located
setwd("./")
...
### Make plots ###
box_20 = ggplot() +
  geom_boxplot(data = dataWQ_20, aes(Depth_m, Concentration, colour = Depth_m), size=0.8) +
  geom_point(data = dataWQ_20, aes(Depth_m, Concentration, colour = Depth_m), size=0.8) +
...
box_21 = ggplot() +
  geom_boxplot(data = dataWQ_21, aes(Depth_m, Concentration, colour = Depth_m), size=0.8) +
  geom_point(data = dataWQ_21, aes(Depth_m, Concentration, colour = Depth_m), size=0.8) +
  labs(x = "Depth (m)", y = "Concentration (mg/L)") +
...
png('MUX_WQ_boxplots_101822.png', width = 190, height = 200, units = 'mm', res = 600)
